...
public class AbpEnterpriseDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AbpEnterpriseGlobalFeatureConfigurator.Configure();
        AbpEnterpriseModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AbpEnterpriseDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AbpEnterpriseResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AbpEnterprise");

            options.DefaultResourceType = typeof(AbpEnterpriseResource);
        ...
        {
            options.MapCodeNamespace("AbpEnterprise", typeof(AbpEnterpriseResource));
        });
    }
}
