...
using AbpEnterprise.EntityFrameworkCore.Enterprise;
...
public class AbpEnterpriseDbContext :
    AbpDbContext<AbpEnterpriseDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public AbpEnterpriseDbContext(DbContextOptions<AbpEnterpriseDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AbpEnterpriseConsts.DbTablePrefix + "Books",
        ...
        //{
        //    b.ToTable(AbpEnterpriseConsts.DbTablePrefix + "YourEntities", AbpEnterpriseConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
