...
namespace AbpEnterprise.Migrations
{
    /// <inheritdoc />
    public partial class test2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEnterpriseIndustries", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppEnterpriseTypeAddresses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEnterpriseTypeAddresses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    EnterpriseIndustryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEnterpriseTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEnterpriseTypes_AppEnterpriseIndustries_EnterpriseIndustryId",
                        column: x => x.EnterpriseIndustryId,
                        principalTable: "AppEnterpriseIndustries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AppEnterpriseTypeAddressCombines",
                columns: table => new
                {
                    EnterpriseTypeAddressId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EnterpriseTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EnterpriseTypeAddressId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEnterpriseTypeAddressCombines", x => new { x.EnterpriseTypeAddressId, x.EnterpriseTypeId });
                    table.ForeignKey(
                        name: "FK_AppEnterpriseTypeAddressCombines_AppEnterpriseTypeAddresses_EnterpriseTypeAddressId",
                        column: x => x.EnterpriseTypeAddressId,
                        principalTable: "AppEnterpriseTypeAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEnterpriseTypeAddressCombines_AppEnterpriseTypeAddresses_EnterpriseTypeAddressId1",
                        column: x => x.EnterpriseTypeAddressId1,
                        principalTable: "AppEnterpriseTypeAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEnterpriseTypeAddressCombines_AppEnterpriseTypes_EnterpriseTypeId",
                        column: x => x.EnterpriseTypeId,
                        principalTable: "AppEnterpriseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseIndustries_Code",
                table: "AppEnterpriseIndustries",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseIndustries_IsActive",
                table: "AppEnterpriseIndustries",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseIndustries_Name",
                table: "AppEnterpriseIndustries",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseTypeAddressCombines_EnterpriseTypeAddressId1",
                table: "AppEnterpriseTypeAddressCombines",
                column: "EnterpriseTypeAddressId1");

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseTypeAddressCombines_EnterpriseTypeId",
                table: "AppEnterpriseTypeAddressCombines",
                column: "EnterpriseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseTypeAddresses_Address",
                table: "AppEnterpriseTypeAddresses",
                column: "Address");

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseTypes_EnterpriseIndustryId_Code",
                table: "AppEnterpriseTypes",
                columns: new[] { "EnterpriseIndustryId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseTypes_IsActive",
                table: "AppEnterpriseTypes",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppEnterpriseTypes_Name",
                table: "AppEnterpriseTypes",
                column: "Name");
